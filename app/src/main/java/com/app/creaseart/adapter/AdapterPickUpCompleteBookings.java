 ...
 */
public class AdapterPickUpCompleteBookings extends RecyclerView.Adapter<AdapterPickUpCompleteBookings.CustomViewHolder> {

    ArrayList<ModelCategory> detail;
    Context mContext;
    OnCustomItemClicListener listener;

    public AdapterPickUpCompleteBookings(Context context, OnCustomItemClicListener lis, ArrayList<ModelCategory> list) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int position) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_pickup_complete_booking, viewGroup, false);
