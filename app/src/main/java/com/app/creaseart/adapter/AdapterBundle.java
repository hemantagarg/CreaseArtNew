 ...
 */
public class AdapterBundle extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterBundle(Context context, OnCustomItemClicListener lis, ArrayList<ModelPackage> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).text_date.setText(m1.getBundlePrice());
