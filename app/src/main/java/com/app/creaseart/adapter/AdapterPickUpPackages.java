 ...
 */
public class AdapterPickUpPackages extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<Packages> detail;
    Context mContext;
    ...
    public AdapterPickUpPackages(Context context, OnCustomItemClicListener lis, ArrayList<Packages> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_pickup_package, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            Packages m1 = (Packages) detail.get(i);
    ...
    public int getItemViewType(int position) {
        Packages m1 = (Packages) detail.get(position);
