 ...
 */
public class AdapterCoupans extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<ModelCoupans> detail;
    Context mContext;
    ...
    public AdapterCoupans(Context context, OnCustomItemClicListener lis, ArrayList<ModelCoupans> list) {
    ...
    public int getItemViewType(int position) {
        ModelCoupans m1 = (ModelCoupans) detail.get(position);
