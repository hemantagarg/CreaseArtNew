 ...
 */
public class AdapterPickUpAfterConvertedBookings extends RecyclerView.Adapter<AdapterPickUpAfterConvertedBookings.CustomViewHolder> {

    ArrayList<ModelCategory> detail;
    Context mContext;
    OnCustomItemClicListener listener;

    public AdapterPickUpAfterConvertedBookings(Context context, OnCustomItemClicListener lis, ArrayList<ModelCategory> list) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int position) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_pickup_afterconverted_booking, viewGroup, false);
    ...
    public void onBindViewHolder(CustomViewHolder customViewHolder, final int i) {
        ...
        customViewHolder.text_steakercode.setText("Sticker Code"+ " : "+detail.get(i).getStickerCode());
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        Button btn_reject,btn_confirmorder,btn_completeorder;
        TextView text_servicename,text_steakercode,text_username, text_servicesubcat, text_serviceprice, text_date,text_status;
        ...
        public CustomViewHolder(View view) {
            ...
            this.text_steakercode = (TextView) view.findViewById(R.id.text_steakercode);
