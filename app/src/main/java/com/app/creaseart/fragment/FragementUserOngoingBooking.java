...
public class FragementUserOngoingBooking extends BaseFragment implements OnCustomItemClicListener, ApiResponse {
            ...
            if (method == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        serviceDetail.setDeliveryTime(jo.getString("DeliveryTime"));
