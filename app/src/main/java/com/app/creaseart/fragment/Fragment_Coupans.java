...
import com.app.creaseart.adapter.AdapterCoupans;
...
import com.app.creaseart.models.ModelCoupans;
 ...
 */
public class Fragment_Coupans extends BaseFragment implements ApiResponse, OnCustomItemClicListener {


    private RecyclerView list_request;
    private Bundle b;
    private Activity context;
    private AdapterCoupans adapterCoupans;
    private ModelCoupans modelCoupans;
    private ArrayList<ModelCoupans> arrayList;
    ...
    public static Fragment_Coupans fragmentPackage;
    private final String TAG = Fragment_Coupans.class.getSimpleName();

    public static Fragment_Coupans getInstance() {
        if (fragmentPackage == null)
            fragmentPackage = new Fragment_Coupans();
    ...
    private void manageHeaderView() {
        ...
        HeaderViewManager.getInstance().setHeading(true, "Coupans");
        ...
        try {
            ...
            if (AppUtils.isNetworkAvailable(context)) {
             ...
             /*   HashMap<String, Object> hm = new HashMap<>();*/
                String url = JsonApiHelper.BASEURL + JsonApiHelper.COUPANS+"zone_id="+ AppUtils.getZoneId(context);
        ...
        try {
            if (position == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    JSONArray array = data.getJSONArray("Coupon");
                    arrayList.clear();
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        ModelCoupans modelCoupans = null;
                        try {
                            modelCoupans = gson.fromJson(array.getJSONObject(i).toString(), ModelCoupans.class);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }

                        modelCoupans.setRowType(1);

                        arrayList.add(modelCoupans);
                    }
                    adapterCoupans = new AdapterCoupans(getActivity(), this, arrayList);
                    list_request.setAdapter(adapterCoupans);
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    adapterCoupans.notifyDataSetChanged();
                    loading = true;
                    if (data.length() == 0) {
