 ...
 */
public class Fragment_Bundle extends BaseFragment implements OnCustomItemClicListener {
    ...
    public static Fragment_Bundle fragmentPackage;
    private final String TAG = Fragment_Bundle.class.getSimpleName();

    public static Fragment_Bundle getInstance() {
        if (fragmentPackage == null)
            fragmentPackage = new Fragment_Bundle();
        ...
        try {
            ...
            if (bundle != null) {
                if (bundle.containsKey("array")) {
                    ...
                    adapterPackages = new AdapterBundle(getActivity(), this, arrayList);
    ...
    public void onItemClickListener(int position, int flag) {
        if (flag == 1) {
            ...
            Fragment_Item fragment_bundle = new Fragment_Item();
